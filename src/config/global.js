export default {
  ...
  menuPrincipal: {
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/122112_CF12_DU.zip',
      },
      {
  ...
  referencias: [
    ...
    {
      referencia:
        'Cámara de Representantes. (2011). Decreto 410 (1971). Código de Comercio. Artículo 86. Funciones de las cámaras de comercio. Recuperado de ',
      link:
